...
func (m Model) View() string {
	...
	footer := muted.Render("MOVE: hjkl focus, J/K scroll, Ctrl+d/u page, G tail, n/p term session, Enter/a attach, x kill, r refresh, q quit | EDIT: i (Chat/Terminal), ↑↓ history, Enter send/newline (Chat), Ctrl+n new shell, Ctrl+t custom terminal cmd, Esc back | terminal embed=view-only, detach: Ctrl+Q")
